    ...
    Tables: {
      ...
      follows: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "follows_follwing_id_profiles_profile_id_fk"
            columns: ["follwing_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
      ...
      gpt_ideas_like: {
        ...
        Relationships: [
          {
            foreignKeyName: "gpt_ideas_like_gpt_idea_id_gpt_ideas_gpt_idea_id_fk"
            columns: ["gpt_idea_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "gpt_ideas_like_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
